...
static inline vertex_t get_v0_from_edge(const packed_edge* p) {
  return p->v0;
}

static inline vertex_t get_v1_from_edge(const packed_edge* p) {
  return p->v1;
}

static inline void write_edge(packed_edge* p, vertex_t v0, vertex_t v1) {
  p->v0 = v0;
  p->v1 = v1;
}
